...
namespace Args
{
    public class OpenDocumentArgs : EventArgs
    {
        ...
        public OpenDocumentArgs(string path, int line, int column, int sellength)
        {
            Path = path;
            iLine = line;
            iColumn = column;
